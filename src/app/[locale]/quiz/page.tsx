...
const translations = {
  pl: {
    ...
    gdprLabel: "Wyrażam zgodę na przetwarzanie mojego adresu e-mail przez Administratora (wydawca VistulaVogue, meenaarpit907@gmail.com) w celu bezpłatnego przesłania 24-stronicowego raportu PDF oraz otrzymywania spersonalizowanych newsletterów edukacyjno-promocyjnych. Zgoda jest dobrowolna i może być cofnięta w każdej chwili.",
  ...
  en: {
    ...
    gdprLabel: "I consent to the processing of my email address by the Administrator (VistulaVogue publisher, meenaarpit907@gmail.com) for the purpose of receiving the custom 24-page PDF skincare guide and promotional newsletters. Consent is voluntary and can be revoked at any time.",
